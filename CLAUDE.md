...
#### 시도는 주소에서 읽되 운영기관으로 메웁니다

동명이역이 19쌍 있습니다. `송정`이 서울 5호선과 부산 동해선에 있고 339km 떨어져
있어 노선명만으로는 어디인지 알기 어렵습니다. 그래서 `region`을 담습니다.

**주소가 시도로 시작하지 않는 행이 94개입니다.** 전부 대구교통공사(91)와
구리도시공사(3)이고 둘 다 한 시도 안에서만 운영하므로 기관 이름으로 메웁니다.
